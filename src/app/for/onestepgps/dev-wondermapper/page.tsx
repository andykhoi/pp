...
export default function Mag() {
	return (
		<GridLayout>
			...
			<ProjectNav back={'/for/onestepgps'} link='https://maps.productions.wondermapper.com/wonder-california' />

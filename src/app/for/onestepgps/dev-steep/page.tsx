...
export default function Mag() {
	return (
		<GridLayout>
			...
			<ProjectNav back={'/for/onestepgps'} link='https://steepla.com/' />
			...
			<Text>
				Built on the Shopify platform. Each component was built with web custom elements and shopify Liquid to populate content.
				<br></br><br></br>
			</Text>
			<Spacer height='100px'/>
		</GridLayout>
